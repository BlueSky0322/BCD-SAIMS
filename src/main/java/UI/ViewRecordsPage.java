...
public class ViewRecordsPage extends javax.swing.JFrame {
     ...
     */
    public ViewRecordsPage(User user) {
        initComponents();
        this.user = user;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Student Academic Information");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(studIDTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(43, 43, 43)
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        // TODO checkAdd your handling code here:
        String ID = studIDTextField.getText();
        if (ID.isBlank() || ID.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Some fields are blank.");
        } else {
            matchingRecord = UserFunctions.searchStudAcaInfo(ID);
            if (matchingRecord != null) {
                dataTextArea.setText("");
                dataTextArea.append(matchingRecord.toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewRecordsPage(new User()).setVisible(true);
            }
        });
    }
